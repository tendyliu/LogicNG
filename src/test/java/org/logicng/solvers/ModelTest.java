...
public class ModelTest {
    ...
    public static Collection<Object[]> solvers() {
        ...
        final List<Pair<MiniSatConfig, String>> configs = Arrays.asList(
                new Pair<MiniSatConfig, String>(configNoPGAux, "FF CNF, +AUX"),
                new Pair<MiniSatConfig, String>(configNoPGNoAux, "FF CNF, -AUX"),
                new Pair<MiniSatConfig, String>(configPGAux, "PG CNF, +AUX"),
                new Pair<MiniSatConfig, String>(configPGNoAux, "PG CNF, -AUX")
        );
    ...
    public void testNonCNFRestrictedVars() throws ParserException {
        ...
        this.solver.add(formula);
        this.solver.sat();
        final SortedSet<Variable> relevantVariables = new TreeSet<Variable>(Arrays.asList(f.variable("A"), f.variable("B"), f.variable("C")));
    ...
    public void testNonCNFRestrictedAndAdditionalVars() throws ParserException {
        ...
        this.solver.sat();
        final SortedSet<Variable> relevantVariables = new TreeSet<Variable>(Arrays.asList(f.variable("A"), f.variable("B"), f.variable("C")));
        final SortedSet<Variable> additionalVariables = new TreeSet<Variable>(Arrays.asList(f.variable("D"), f.variable("X"), f.variable("Y")));
        final SortedSet<Variable> allVariables = new TreeSet<Variable>(relevantVariables);
