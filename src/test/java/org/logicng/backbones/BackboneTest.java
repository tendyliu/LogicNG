...
public class BackboneTest {
    ...
    public void testToFormula() throws ParserException {
        Backbone backbone = new Backbone(set(this.a1, this.a2, this.a3), null, null);
        assertThat(backbone.toFormula(this.f)).isEqualTo(this.p.parse("a1 & a2 & a3"));
        backbone = new Backbone(null, set(this.b1, this.b2, this.b3), null);
        assertThat(backbone.toFormula(this.f)).isEqualTo(this.p.parse("~b1 & ~b2 & ~b3"));
        backbone = new Backbone(set(this.a1, this.a2, this.a3), set(this.b1), null);
        assertThat(backbone.toFormula(this.f)).isEqualTo(this.p.parse("a1 & a2 & a3 & ~b1"));
        backbone = new Backbone(set(this.a1, this.a2, this.a3), null, set(this.x1, this.x2, this.x3));
        assertThat(backbone.toFormula(this.f)).isEqualTo(this.p.parse("a1 & a2 & a3"));
        backbone = new Backbone(null, set(this.b1, this.b2, this.b3), set(this.x1, this.x2, this.x3));
        assertThat(backbone.toFormula(this.f)).isEqualTo(this.p.parse("~b1 & ~b2 & ~b3"));
        backbone = new Backbone(set(this.a1), set(this.b1, this.b2, this.b3), set(this.x1));
        assertThat(backbone.toFormula(this.f)).isEqualTo(this.p.parse("a1 & ~b1 & ~b2 & ~b3"));
    }

    @Test
    public void testToMap() {
        Backbone backbone = new Backbone(set(this.a1, this.a2), null, null);
        ...
        backbone = new Backbone(set(this.a1), set(this.b1, this.b2), set(this.x1));
        assertThat(backbone.toMap()).containsExactly(
                MapEntry.entry(this.a1, TRUE),
                MapEntry.entry(this.b1, FALSE),
                MapEntry.entry(this.b2, FALSE),
    ...
    public void testToString() {
        final Backbone backbone = new Backbone(set(this.a1, this.a2, this.a3), set(this.b1, this.b2, this.b3), set(this.x1, this.x2, this.x3));
    ...
    public void testEqualsAndHashCode() {
        final Backbone backbone1a = new Backbone(set(this.a1, this.a2, this.a3), null, null);
        final Backbone backbone1b = new Backbone(set(this.a1, this.a2, this.a3), null, null);
        final Backbone backbone3 = new Backbone(set(this.a1, this.a2, this.a3), set(this.b1), null);
        final Backbone backbone5 = new Backbone(null, set(this.b1, this.b2, this.b3), set(this.x1, this.x2, this.x3));
