...
public final class MiniSatConfig extends Configuration {
    ...
    public String toString() {
        ...
        sb.append("bbInitialUBCheckForRotatableLiterals=").append(this.bbInitialUBCheckForRotatableLiterals).append(String.format("%n"));
        sb.append("bbCheckForComplementModelLiterals=").append(this.bbCheckForComplementModelLiterals).append(String.format("%n"));
        sb.append("bbCheckForRotatableLiterals=").append(this.bbCheckForRotatableLiterals).append(String.format("%n"));
