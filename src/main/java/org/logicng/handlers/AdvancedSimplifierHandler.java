...
/**
 * Interface for a handler for the advanced simplification.
 * @version 2.1.0
 * @since 2.1.0
 */
public interface AdvancedSimplifierHandler extends Handler {
    ...
    /**
     * Returns a SMUS handler which can be used to cancel the internal SMUS computation.
     * @return a SMUS handler
     */
    default SmusHandler smusHandler() { return null; }
}